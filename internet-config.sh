...
while :
do
  echo -e " \033[1;36mPPPoE IPv4 ------------------------------------------\033[0;39m"
...
while :
do
  echo -e " \033[1;31mPPPoE IPv4 IPv6 -------------------------------------\033[0;39m"
...
do
  ...
  echo -e " \033[1;36m[v]: v6 コネクト自動設定\033[0;39m"
  echo -e " \033[1;31m[p]: PPPoE (iPv4・IPv6): 要認証ID (ユーザー名)・パスワード\033[0;39m"
