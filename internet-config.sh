...
while :
do
  echo -e " \033[1;33mONUに直結下さい\033[0;39m"
  echo -e " \033[1;33m光電話付非対応\033[0;39m"
  echo -e " \033[1;34mOCNバーチャルコネクト --------------------------------\033[0;39m"
  echo -e " \033[1;34m[e]\033[0;39m": OCNバーチャルコネクトの設定を実行します（ニチバン対策含む）
...
do
  ...
  echo -e " \033[1;34m[e]\033[0;39m": V6プラス・IPv6オプションの設定を実行します（ニチバン対策含む）
